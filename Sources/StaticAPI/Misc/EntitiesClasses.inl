...
ES_CLASS_INLINE(CAcid)
ES_CLASS_INLINE(CAirWave)
...
ES_CLASS_INLINE(CFishman)
ES_CLASS_INLINE(CFlame)
ES_CLASS_INLINE(CFogMarker)
ES_CLASS_INLINE(CGhostBusterRay)
...
ES_CLASS_INLINE(CHuanman)
ES_CLASS_INLINE(CItem)
ES_CLASS_INLINE(CKeyItem)
ES_CLASS_INLINE(CLight)
ES_CLASS_INLINE(CLightning)
ES_CLASS_INLINE(CMamut)
ES_CLASS_INLINE(CMamutman)
ES_CLASS_INLINE(CMantaman)
...
ES_CLASS_INLINE(CRobotDriving)
ES_CLASS_INLINE(CRobotFlying)
